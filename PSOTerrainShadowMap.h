...
/// </summary>
class PSOTerrainShadowMap
{
public:
	PSOTerrainShadowMap(std::wstring vertexName, std::wstring hullName, std::wstring domainName, D3D12_PRIMITIVE_TOPOLOGY_TYPE type, bool useDepth = true);
